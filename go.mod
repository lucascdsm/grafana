...
require (
	...
	cloud.google.com/go/kms v1.19.1 // @grafana/grafana-backend-group
	...
	google.golang.org/api v0.196.0 // @grafana/grafana-backend-group
...
require (
	...
	github.com/grafana/grafana/apps/playlist v0.0.0-20240913202740-d1ffcc22d915
)
